...
if(isset($_GET['error'])){
  ...
  if($error = 1){
    $error_message = "this agent has already been added";
  }
}
...
<body class="bg-dark">
  ...
  <div class="container" style="min-height: 62vh;">
    <div class="text-white">
      <h2 class="text-center my-4">เพิ่มข้อมูลเจนท์</h2>
      <div class="row d-flex justify-content-center align-items-center">
        <div class="col-md-5">
          <form class="mx-auto" method="POST" action="checkaddagent.php" enctype="multipart/form-data">
          <div class="mb-3">
            ...
            <div class=" mb-3">
              <label for="game" class="form-label">ดูแลเกม</label>
              <select id="game" class="form-select loginform" name="game">
                <?php
                if ($count_row != 0) {
