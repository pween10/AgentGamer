...
// }
// echo $userID;
$sqlGame = "SELECT g.gameID, g.gameName ,c.gameCateID ,c.gameCateName, g.gamePic
    FROM tbl_game as g
  ...
  <div class="container ">
    ...
    <div class="text-white">
      ...
      <div class="text-center">
        <img src="img/<?php echo $result1['gamePic']; ?>" class="img" class="mb-3" alt="">
        <!-- <div>
      ...
      <div class="row d-flex justify-content-center align-items-center">
        <div class="col-md-5">
          <form action="checkEditgame.php" method="post" enctype="multipart/form-data" class="mx-auto">
            <div class="mb-3 ">
              <div class="mb-3">
                <input type="hidden" class="form-control rounded-radius loginform" name="id" id="id" placeholder="" value="<?php echo $result1['gameID']; ?>">
              </div>
              <label for="fname" class="form-label">ชื่อเกม</label>
              <input type="text" class="form-control rounded-radius loginform" name="name" id="name" placeholder="ชื่อ" value="<?php echo $result1['gameName']; ?>">
            </div>
